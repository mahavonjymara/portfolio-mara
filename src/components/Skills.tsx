...
function TechBadge({ name, color, bg, letter }: TechItem) {
  const svgIcons: Record<string, JSX.Element> = {
    ...
    "Linux": <svg viewBox="0 0 24 24" width="20" height="20" fill="#e95420"><path d="M12.504 0c-.155 0-.315.008-.48.021-4.226.333-3.105 4.807-3.17 6.298-.076 1.092-.3 1.953-1.05 3.02-.885 1.051-2.127 2.75-2.716 4.521-.278.832-.41 1.684-.287 2.489a.424.424 0 0 0-.11.135c-.26.268-.45.6-.663.839-.199.199-.485.267-.797.4-.313.136-.658.269-.864.68-.09.189-.136.394-.132.602 0 .199.027.4.055.536.058.399.116.728.04.97-.249.68-.28 1.145-.106 1.484.174.334.535.47.94.601.81.2 1.91.135 2.774.6.926.466 1.866.67 2.616.47.526-.138.unconventional1.27-.37 1.755-.7a8.2 8.2 0 0 0 1.056-.62c.532-.39.98-.81 1.61-.952a5.06 5.06 0 0 1 1.932.013c.27.053.65.137 1.05.195.8.116 1.574.098 2.137-.149.56-.247.95-.666 1.21-1.253.057-.137.1-.283.133-.437a.524.524 0 0 0 .012-.09c.24-.41.257-.835.07-1.16-.19-.32-.58-.5-1.05-.61a2.8 2.8 0 0 0-.525-.069c-.32-.01-.67.03-1.01.03-.508 0-.923-.07-1.148-.35-.228-.28-.27-.7-.217-1.32.033-.4.13-.79.173-1.07.066-.395.07-.67-.027-.87-.32-.65-.91-.97-1.63-1.12-.72-.14-1.54-.1-2.31-.06-.42.02-.84.06-1.22.07-.44.01-.82-.01-1.07-.15-.26-.14-.34-.42-.33-.81.02-.4.14-.87.26-1.32.26-.99.57-1.96.57-2.88 0-.36-.04-.7-.15-1.01-.23-.65-.7-1.08-1.29-1.27-.6-.19-1.3-.16-1.96.01-.66.17-1.28.48-1.76.9-.47.42-.77.95-.87 1.54-.1.59.01 1.24.3 1.84.29.61.77 1.17 1.35 1.6.29.22.59.4.9.53.3.13.61.21.91.21.31 0 .61-.08.87-.25.26-.17.47-.44.6-.77.12-.33.15-.72.07-1.1-.08-.39-.28-.75-.57-1.02-.28-.27-.64-.44-1.01-.44-.36 0-.69.17-.93.46-.24.28-.37.67-.34 1.07.02.2.08.4.19.56.1.17.25.3.42.38.17.08.37.11.56.08.2-.03.38-.12.52-.26.14-.14.24-.33.27-.54.03-.21-.01-.43-.12-.62-.11-.18-.28-.32-.48-.39a.84.84 0 0 0-.59.02c-.19.07-.35.21-.46.38-.11.17-.16.38-.14.59.02.2.1.4.24.55.13.15.31.25.5.28.19.03.38-.01.54-.11.17-.1.3-.25.38-.43.08-.18.1-.39.05-.59-.04-.2-.15-.38-.3-.52a.84.84 0 0 0-.53-.2c-.2 0-.39.07-.54.2-.15.13-.25.31-.28.51-.03.2 0 .41.1.59.1.18.25.33.44.42.19.09.4.11.6.07.2-.04.39-.15.52-.31.13-.16.21-.36.21-.57 0-.21-.07-.41-.21-.57-.13-.16-.32-.27-.52-.31a.87.87 0 0 0-.6.07c-.19.09-.34.24-.44.42-.1.18-.13.39-.1.59.03.2.13.38.28.51.15.13.34.2.54.2.2 0 .39-.07.53-.2.14-.14.23-.32.26-.52.03-.2-.01-.41-.12-.58-.1-.18-.26-.31-.45-.38a.82.82 0 0 0-.58.02c-.19.08-.35.22-.45.4-.1.17-.14.38-.11.58.03.2.12.39.27.53.14.14.33.22.52.22.19 0 .38-.08.52-.22.14-.14.22-.33.22-.52 0-.2-.08-.38-.22-.52a.74.74 0 0 0-.52-.22z"/></svg>,
    "MERISE": <svg viewBox="0 0 24 24" width="20" height="20" fill="#8b5cf6"><rect x="2" y="8" width="8" height="8" rx="1"/><rect x="14" y="8" width="8" height="8" rx="1"/><line x1="10" y1="12" x2="14" y2="12" stroke="#8b5cf6" strokeWidth="2"/><circle cx="12" cy="4" r="2"/><line x1="12" y1="6" x2="12" y2="8" stroke="#8b5cf6" strokeWidth="1.5"/></svg>,
    ...
    "Figma": <svg viewBox="0 0 24 24" width="20" height="20" fill="#f24e1e"><path d="M15.852 8.981h-4.588V0h4.588c2.476 0 4.49 2.014 4.49 4.49s-2.014 4.491-4.49 4.491zM12.735 7.51h3.117c1.665 0 3.019-1.355 3.019-3.02s-1.354-3.019-3.019-3.019h-3.117V7.51zm0 1.471H8.148c-2.476 0-4.49-2.015-4.49-4.491S5.672 0 8.148 0h4.588v8.981zm-4.587-7.51c-1.665 0-3.019 1.355-3.019 3.02s1.354 3.019 3.019 3.019h3.117V1.471H8.148zm4.587 15.019H8.148c-2.476 0-4.49-2.014-4.49-4.49s2.014-4.49 4.49-4.49h4.588v8.98zM8.148 8.981c-1.665 0-3.019 1.355-3.019 3.019s1.354 3.02 3.019 3.02h3.117V8.981H8.148zM8.172 24c-2.489 0-4.515-2.014-4.515-4.49s2.026-4.49 4.515-4.49c2.489 0 4.515 2.014 4.515 4.49S10.661 24 8.172 24zm0-7.509c-1.665 0-3.044 1.355-3.044 3.019s1.379 3.019 3.044 3.019c1.665 0 3.044-1.355 3.044-3.019s-1.379-3.019-3.044-3.019zm7.705 7.509c-2.476 0-4.49-2.014-4.49-4.49V15h4.49c2.476 0 4.49 2.014 4.49 4.49S18.353 24 15.877 24zm-3.019-4.49c0 1.665 1.354 3.019 3.019 3.019s3.019-1.354 3.019-3.019-1.354-3.019-3.019-3.019h-3.019v3.019z"/></svg>,
    "Tailwind": <svg viewBox="0 0 24 24" width="20" height="20" fill="#06b6d4"><path d="M12.001 4.8c-3.2 0-5.2 1.6-6 4.8 1.2-1.6 2.6-2.2 4.2-1.8.913.228 1.565.89 2.288 1.624C13.666 10.618 15.027 12 18.001 12c3.2 0 5.2-1.6 6-4.8-1.2 1.6-2.6 2.2-4.2 1.8-.913-.228-1.565-.89-2.288-1.624C16.337 6.182 14.976 4.8 12.001 4.8zm-6 7.2c-3.2 0-5.2 1.6-6 4.8 1.2-1.6 2.6-2.2 4.2-1.8.913.228 1.565.89 2.288 1.624 1.177 1.194 2.538 2.576 5.512 2.576 3.2 0 5.2-1.6 6-4.8-1.2 1.6-2.6 2.2-4.2 1.8-.913-.228-1.565-.89-2.288-1.624C10.337 13.382 8.976 12 6.001 12z"/></svg>,
  };
